...
const FaceWithSpiralEyesIcon = (
  props: JSX.IntrinsicAttributes &
    IconComponentProps &
    RefAttributes<HTMLSpanElement>
): JSX.Element => {
  return <Icon component={FaceWithSpiralEyesSVG} {...props} />;
};

export default FaceWithSpiralEyesIcon;
